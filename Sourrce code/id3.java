...
class id3
{
	public static void main(String args[])
	{
		...
		JLabel l3 = new JLabel("Registration Number");
		...
		JLabel l4 = new JLabel("Name of Hospital");
		...
		JLabel l10 = new JLabel("*Last Registration number Are: ");
		f.add(l10);
		l10.setFont(new Font("Algerian",Font.BOLD,30));
		l10.setBounds(190,550,600,35);
	...
	JOptionPane.showMessageDialog(null,"Enter pincode");
		...
		{
		JOptionPane.showMessageDialog(null,"already registerd Registartion number");
		}
		...
		l10.setText("Last Registration number Are:  "+rs.getInt("max(reg)"));
