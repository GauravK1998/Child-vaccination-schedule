...
class id2
{
	public void fun(String abc1,String abc2,String abc3,String abc4,String abc5,String abc6,String abc7,String abc8,String abc9,String abc10,String abc11)
	{
	String check ="";
	...
	JOptionPane.showMessageDialog(null,"Enter Confirm Password");
		...
		{
		JFrame f = new JFrame("Mother Registration");
		f.setVisible(true);
		...
		JLabel l1 = new JLabel("MOTHER REGISTRATION");
		l1.setFont(f1);
		f.add(l1);
		...
		JLabel l3 = new JLabel("Husband Name");
		...
		JLabel l4a = new JLabel("Aadhar Number");
		...
		JLabel l5 = new JLabel("D.O.B(DD/MM/YY)");
		...
		JLabel l12 = new JLabel("* Mother Name as a UserName");
		l12.setFont(f2);
		f.add(l12);
		l12.setBounds(130,590,500,30);
		...
		{
		id2 obj = new id2();
		obj.fun(t1.getText(),t2.getText(),t3.getText(),t3a.getText(),t4.getText(),t5.getText(),t6.getText(),t7.getText(),t8.getText(),String.valueOf(t9.getPassword()),String.valueOf(t10.getPassword()));
		break;
